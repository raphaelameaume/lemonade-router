...
function Router({
    ...
    let history$1 = history.createBrowserHistory({ basename });
    let prevView = null;
    ...
    */
    ...
    async function apply(location, prevPathname) {
        try {
            ...
            if (nextView) {
                router.nextLocation = history$1.createHref(location);
    ...
    */
    function listen({ clickEvents = false, clickIgnoreClass = 'no-router' } = {}) {
        ...
        apply(history$1.location, prevPathname);
